...
import motherday2025 from './components/banner/motherday2025';
import canvasPopup from './components/banner/canvasPopup';
...
(function (jQuery, OVERLAYBANNER) {
  ...
  OVERLAYBANNER.initBanner = (target, specific) => {
    ...
    const _callback = () => {
      canvasPopup({
        rendered: () => POPUP_BANNER.addCountOfShow(1, CAMPAIGN.FATHERDAY2025),
      });
    };
