...
POPUP_BANNER.render = (options) => {
  ...
  if (campaign == CAMPAIGN.VDAY2025APPLE) {
    if (UTIL.locale() == 'EN') {
      ga('send', 'event', 'OS_pop_en', 'Impression', '202502_Apple_Vdayv2_impression');
    } else {
      ga('send', 'event', 'OS_pop_tc', 'Impression', '202502_Apple_Vdayv2_impression');
    }
  }
  ...
  //OSO-306
  if (campaign == CAMPAIGN.FATHERDAY2025) {
    if (UTIL.locale() == 'EN') {
      ga('send', 'event', 'OS_pop_en', 'Impression', '202520_fathers_day_impression');
    } else {
      ga('send', 'event', 'OS_pop_tc', 'Impression', '202520_fathers_day_impression');
    }
  }
  ...
  setTimeout(() => {
    ...
    //if animation canvas exists in banner body
...
POPUP_BANNER.registerEvent = ($modal, campaign, content) => {
  ...
  $modal.find('.bannerBody').on('click', () => {
    ...
    if (campaign == CAMPAIGN.VDAY2025APPLE) {
      if (UTIL.locale() == 'EN') {
        ga('send', 'event', 'OS_pop_en', 'Click', '202502_Apple_Vdayv2_click');
      } else {
        ga('send', 'event', 'OS_pop_tc', 'Click', '202502_Apple_Vdayv2_click');
      }
    }
    if (campaign == CAMPAIGN.VDAY2025ANDROID) {
      if (UTIL.locale() == 'EN') {
    ...
    if (campaign == CAMPAIGN.FATHERDAY2025) {
      if (UTIL.locale() == 'EN') {
        ga('send', 'event', 'OS_pop_en', 'Click', '2025020_fathers_day_click');
      } else {
        ga('send', 'event', 'OS_pop_tc', 'Click', '2025020_fathers_day_click');
      }
    }
